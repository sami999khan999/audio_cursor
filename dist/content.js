...
// Built at: 2026-08-16T11:19:53.496Z
...
(() => {
    ...
    function showKbHint(message) {
        ...
        kbHintEl.innerHTML = message
            ...
            : `<span class="ac-kb-title">Text cursor on</span>
               <span class="ac-kb-keys">
                   <b>Press</b> text or <b>↑↓←→</b> move <i>·</i> <b>Shift</b> select <i>·</i>
                   <b>Ctrl</b>+<b>Shift</b> by word <i>·</i> <b>${offKey}</b> off
               </span>`;
